...
The file included in this folder titled "MPISubtensorTTCross_Version2_PyTorch.py" is a self-contained file that will automatically load NumPy, math, PyTorch, and mpi4py. All other functions used are included before the main body of the file begins.

# Description of the code

The provided Python code is split into two main parts:
* 1 - The custom-built functions which go from lines 52 - 1553
* 2 - The implementation of the algorithm, which goes from lines 1556 - 2543
...
"hilbert"   - Hilbert tensor
"maxwell4"  - 4D Maxwellian tensor
"maxwell6"  - 6D Maxwellian tensor

For example, to run the 4D Maxwellian problem, use:

TENSOR_KIND = "maxwell4"
