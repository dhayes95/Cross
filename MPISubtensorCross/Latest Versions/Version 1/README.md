...
* change TENSOR_KIND to your desired one in Line 41 in MPISubtensorTTCross_Version2_NumPy.py
* execute the command mpirun -n 64 MPISubtensorTTCross_Version2_NumPy.py 100000 10 800,400,800,400 10,5,20 1,8,8,1 
